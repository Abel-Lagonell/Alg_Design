...
0.4 - Added the Grid.py class with some utility functions that will make accessing data and changing data easier. Also redid the string overload for the Node so that it can also return the price bracket of the node itself.  
